...
def AppHeader(page: ft.Page, active_route: str):
    """
    Header reutilizable con navegación principal + menú hamburguesa sutil (sin fondo opaco).
    La validación de sesión es ligera; la pantalla de carga al navegar la maneja main.py.
    """
    ...
    # Menú hamburguesa (chips sin fondo opaco)
